...
content = r'''Educational Multi-Armed Bandit Lab.
...
# Double check that we have exactly what we want
if "def main" not in content:
    raise ValueError("Content is missing def main()")

with open("templates/common/bandit_lab.py.tpl", "w", encoding="utf-8") as f:
    f.write(content.strip())
    f.write("\n")

print(f"Wrote {len(content)} characters to templates/common/bandit_lab.py.tpl")
