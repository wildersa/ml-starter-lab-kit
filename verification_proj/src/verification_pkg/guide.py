...
def main() -> None:
    ...
    print(f"  1. python -m verification_pkg.data      (Process your data)")

    advisor_cmd = "python -m verification_pkg.advisor"
    if advisor_cmd:
        print(f"  2. {advisor_cmd}   (Get detailed analysis)")
        print(f"  3. python -m verification_pkg.train     (Train baseline model)")
        print(f"  4. python -m verification_pkg.evaluate  (Evaluate performance)")
    else:
        print(f"  2. python -m verification_pkg.train     (Train baseline model)")
        print(f"  3. python -m verification_pkg.evaluate  (Evaluate performance)")
