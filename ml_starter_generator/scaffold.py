...
def create_package_files(root: Path, values: dict[str, str], *, force: bool) -> None:
    ...
    files = {
        ...
        "rl.py": load_template("rl.py.tpl", values, folder="common"),
        "rl_workspace.py": load_template("rl_workspace.py.tpl", values, folder="common"),
...
def create_docs(root: Path, values: dict[str, str], *, force: bool) -> None:
    ...
    docs = {
        ...
        f"docs/rl-lab{suffix}.md": load_template(f"rl-lab{suffix}.md", values, folder="project/docs"),
